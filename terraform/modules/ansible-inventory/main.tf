...
resource "local_file" "inventory" {
  ...
  content = templatefile("${path.module}/inventory.tftpl", {
    ...
    ap-northeast-2a-worker-node-02 = var.nodes["ap-northeast-2a-worker-02"].private_ip
    ...
    ap-northeast-2b-worker-node-03 = var.nodes["ap-northeast-2b-worker-03"].private_ip
