...
output "master-node-connect-command" {
  value = "ssh -A -J ec2-user@${aws_instance.kt_cloud_vpc_node["ap-northeast-2b-bastion"].public_ip} ec2-user@${aws_instance.kt_cloud_vpc_node["ap-northeast-2a-master-01"].private_ip}"
}
